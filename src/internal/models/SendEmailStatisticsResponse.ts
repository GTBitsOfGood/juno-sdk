...
export function instanceOfSendEmailStatisticsResponse(
  ...
  if (!('uniqueClicks' in value) || value['uniqueClicks'] === undefined)
    return false;
  if (!('opens' in value) || value['opens'] === undefined) return false;
  if (!('uniqueOpens' in value) || value['uniqueOpens'] === undefined)
    return false;
  if (!('blocks' in value) || value['blocks'] === undefined) return false;
  if (!('bounceDrops' in value) || value['bounceDrops'] === undefined)
    return false;
  ...
  if (!('invalidEmails' in value) || value['invalidEmails'] === undefined)
    return false;
  if (!('processed' in value) || value['processed'] === undefined) return false;
  if (!('requests' in value) || value['requests'] === undefined) return false;
  if (!('spamReportDrops' in value) || value['spamReportDrops'] === undefined)
    return false;
  if (!('spamReports' in value) || value['spamReports'] === undefined)
    return false;
  if (!('unsubscribeDrops' in value) || value['unsubscribeDrops'] === undefined)
    return false;
  if (!('unsubscribes' in value) || value['unsubscribes'] === undefined)
    return false;
  return true;
}
