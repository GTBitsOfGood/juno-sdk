...
export class AuthApi extends runtime.BaseAPI {
     ...
     */
    async authControllerDeleteApiKeyByIdRaw(requestParameters: AuthControllerDeleteApiKeyByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            path: `/auth/key/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Revokes an API key, detaching it from its project.
     */
    async authControllerDeleteApiKeyById(requestParameters: AuthControllerDeleteApiKeyByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.authControllerDeleteApiKeyByIdRaw(requestParameters, initOverrides);
    }
     ...
     * Lists all API keys
     */
    async authControllerGetAllApiKeysRaw(requestParameters: AuthControllerGetAllApiKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAllApiKeysResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAllApiKeysResponseFromJSON(jsonValue));
    }

    /**
     * Lists all API keys
     */
    async authControllerGetAllApiKeys(requestParameters: AuthControllerGetAllApiKeysRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAllApiKeysResponse> {
        const response = await this.authControllerGetAllApiKeysRaw(requestParameters, initOverrides);
        return await response.value();
    }
