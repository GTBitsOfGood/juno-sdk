...
export class ProjectApi {
     ...
     */
    public async projectControllerCreateProject (createProjectModel: CreateProjectModel, xUserPassword?: string, xUserEmail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
     ...
     * @param xUserEmail Email of an admin or superadmin user
     */
    public async projectControllerDeleteProjectById (id: string, xUserPassword?: string, xUserEmail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling projectControllerDeleteProjectById.');
        }
     ...
     * @param xUserEmail Email of an admin or superadmin user
     */
    public async projectControllerGetAllProjects (xUserPassword?: string, xUserEmail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/project';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param id 
     */
    public async projectControllerGetProjectById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
        const localVarPath = this.basePath + '/project/id/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param name 
     */
    public async projectControllerGetProjectByName (name: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProjectResponse;  }> {
     ...
     * @param xUserEmail Email of an admin or superadmin user
     */
    public async projectControllerGetUsersByProject (id: string, xUserPassword?: string, xUserEmail?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserResponses;  }> {
        const localVarPath = this.basePath + '/project/{id}/users'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling projectControllerGetUsersByProject.');
        }
     ...
     * @param linkUserModel 
     */
    public async projectControllerLinkUserWithProjectName (name: string, linkUserModel: LinkUserModel, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
